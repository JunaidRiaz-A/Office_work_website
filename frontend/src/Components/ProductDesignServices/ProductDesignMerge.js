...
// import "./../WebsiteDeploymentServicesMerge/ProductDesignMerge.css";
...
import ProductDesignSolution from "../ProductDesignServices/ProductDesignSolution";
import ProductDesignExperience from "../ProductDesignServices/ProductDesignExperience";
import Banner1 from "../Homepage/Banner1/Banner1";
import BringIdeas from "../PortfolioPage/BringIdeas/BringIdeas";

function ProductDesignMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Product & Design Services</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Product & Design Services</p>
        </div>
      </div>
      <ProductDesignSolution scrollToAppointment={scrollToAppointment} />
...
export default ProductDesignMerge;