...
import CloudEngineeringSolution from "../CloudEngineeringSolution/CloudEngineeringSolution";
...
function CloudEngineeringServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Cloud Engineering</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Cloud Engineering</p>
        </div>
      </div>
      <CloudEngineeringSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default CloudEngineeringServicesMerge;