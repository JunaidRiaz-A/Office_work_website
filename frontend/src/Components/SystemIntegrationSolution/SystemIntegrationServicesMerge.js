...
import SystemIntegrationSolution from "../SystemIntegrationSolution/SystemIntegrationSolution";
...
function SystemIntegrationServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">System Integration</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">System Integration</p>
        </div>
      </div>
      <SystemIntegrationSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default SystemIntegrationServicesMerge;