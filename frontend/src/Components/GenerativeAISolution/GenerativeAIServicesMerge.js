...
import GenerativeAISolution from "../GenerativeAISolution/GenerativeAISolution";
...
function GenerativeAIServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Generative AI</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Generative AI</p>
        </div>
      </div>
      <GenerativeAISolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default GenerativeAIServicesMerge;