...
import "./../WebsiteDeploymentServicesMerge/WebdevelopementMerge.css";
...
import WebSolution from "../WebSolution/WebSolution";
import WebPageExperience from "../WebPageExperience/WebPageExperience";
import Banner1 from "../../Homepage/Banner1/Banner1";
import BringIdeas from "../../PortfolioPage/BringIdeas/BringIdeas";

function WebsiteDeploymentServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Custom Software Development</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Custom Software Development</p>
        </div>
      </div>
      <WebSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default WebsiteDeploymentServicesMerge;