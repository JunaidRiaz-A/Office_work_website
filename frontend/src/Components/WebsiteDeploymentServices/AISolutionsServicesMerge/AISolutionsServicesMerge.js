...
import "./../AISolutionsServicesMerge/AISolutionsServicesMerge.css";
...
import BusinessAIGoal from "./BusinessAIGoal";

function AISolutionsServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">AI and Machine Learning Services</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">AI and Machine Learning Service</p>
        </div>
      </div>
      <BusinessAIGoal scrollToAppointment={scrollToAppointment} />
...
export default AISolutionsServicesMerge;