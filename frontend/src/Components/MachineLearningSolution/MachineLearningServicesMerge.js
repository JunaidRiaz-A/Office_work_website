...
import MachineLearningSolution from "../MachineLearningSolution/MachineLearningSolution";
...
function MachineLearningServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Machine Learning</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Machine Learning</p>
        </div>
      </div>
      <MachineLearningSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default MachineLearningServicesMerge;