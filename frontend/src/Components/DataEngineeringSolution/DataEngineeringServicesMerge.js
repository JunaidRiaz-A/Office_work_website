...
import DataEngineeringSolution from "../DataEngineeringSolution/DataEngineeringSolution";
...
function DataEngineeringServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Data Engineering</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Data Engineering</p>
        </div>
      </div>
      <DataEngineeringSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default DataEngineeringServicesMerge;