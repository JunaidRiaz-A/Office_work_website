...
import ProductStrategyConsultingSolution from "../ProductStrategyConsultingSolution/ProductStrategyConsultingSolution";
...
function ProductStrategyConsultingServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Product Strategy & Consulting</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Product Strategy & Consulting</p>
        </div>
      </div>
      <ProductStrategyConsultingSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default ProductStrategyConsultingServicesMerge;