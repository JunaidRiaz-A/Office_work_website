...
import CRMPlatformSolution from "../CRMPlatformSolution/CRMPlatformSolution";
...
function CRMPlatformServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">CRM Platform Implementation</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">CRM Platform Implementation</p>
        </div>
      </div>
      <CRMPlatformSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default CRMPlatformServicesMerge;