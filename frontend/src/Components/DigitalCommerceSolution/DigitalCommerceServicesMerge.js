...
import DigitalCommerceSolution from "../DigitalCommerceSolution/DigitalCommerceSolution";
...
function DigitalCommerceServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Digital Commerce</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Digital Commerce</p>
        </div>
      </div>
      <DigitalCommerceSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default DigitalCommerceServicesMerge;