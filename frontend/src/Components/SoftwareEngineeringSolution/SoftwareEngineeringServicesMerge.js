...
import SoftwareEngineeringSolution from "../SoftwareEngineeringSolution/SoftwareEngineeringSolution";
...
function SoftwareEngineeringServicesMerge() {
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">Software Engineering</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">Software Engineering</p>
        </div>
      </div>
      <SoftwareEngineeringSolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default SoftwareEngineeringServicesMerge;