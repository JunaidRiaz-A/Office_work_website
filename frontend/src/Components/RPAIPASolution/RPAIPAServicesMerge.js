...
import RPAIPASolution from "../RPAIPASolution/RPAIPASolution";
  ...
  return (
    <div>
      ...
      <div className="main_div_webnavbar">
        <p className="Heading_web_navbar">RPA & IPA Implementation</p>
        <div className="d-flex justify-content-center">
          <p className="para_web_navbar_white">Home</p>
          <p className="para_web_navbar_white">
            <MdOutlineKeyboardArrowRight />
          </p>
          <p className="para_web_navbar_orange">RPA & IPA Implementation</p>
        </div>
      </div>
      <RPAIPASolution scrollToAppointment={scrollToAppointment} />
      <WebPageExperience />
...
export default RPAIPAServicesMerge;